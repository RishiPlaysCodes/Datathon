    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="mt-4 text-center">
          <a href="/citizen" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-green-600/20 text-green-400 border border-green-500/30 hover:bg-green-600/30 transition-all">
            👥 Citizen Portal — File & Track Complaints (No login)
          </a>
        </div>
